 ...
 * @apiNote
 *
 * CloseableHttpClient是在HttpClient的基础上修改更新而来的，这里还涉及到请求头token的设置（请求验证），
 * 利用fastjson转换请求或返回结果字符串为json格式，当然上面两种方式也是可以设置请求头token、json的，这里只在下面说明。
 */
public class ClosableHttpClientUtil{
    private static String tokenString = "della";
