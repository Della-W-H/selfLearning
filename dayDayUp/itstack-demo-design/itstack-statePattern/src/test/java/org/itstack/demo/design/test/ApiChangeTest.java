...
import org.itstack.demo.design.change.Result;
import org.itstack.demo.design.change.StateHandler;
...
public class ApiChangeTest {
    ...
    private Logger logger = LoggerFactory.getLogger(ApiChangeTest.class);
